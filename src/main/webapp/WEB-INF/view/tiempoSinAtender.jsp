...
<html lang="es">
    ...
    <body>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h1 class="titulos-graficas-barras titulos-barra">Cajeros sin atender turnos por d&iacute;a</h1>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 sombra">
            <div class="col-lg-8 col-md-8 col-sm-12 col-lg-offset-2 col-md-offset-2">
                ...
                <div class="col-lg-4 col-md-4 col-lg-offset-2 col-lg-offset-2">
                    <h2 class="banda">M&iacute;nimo: <strong id="minimo" class="remarca"></strong></h2>
                    <h2 class="banda">M&aacute;ximo: <strong id="maximo" class="remarca"></strong></h2>
                </div>
            </div>
        </div>
        <!-- GRAFICA-->
        ...
        <script type="text/javascript">
            ...
            $LAB
                    ...
                    .script(_CONTEXT_PATH.concat("/resource/js/client/cjcr-tiemposinatend-client.js")).wait()
                    .script(_CONTEXT_PATH.concat("/resource/js/app/cjcr-tiempoSinAtend-init.js")).wait()
                    .script(_CONTEXT_PATH.concat("/resource/js/app/cjcr-tiempoSinAtend-view.js")).wait();
            </script>   
    </body>
</html>