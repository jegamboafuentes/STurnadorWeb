...
\
    <div class = "row titulo">\
      <div class="col-lg-6 col-md-6 col-sm-6">\
        <div class="vcenter">\
          <a href="../turnos atendidos/generales.html"><h1 id="ir-a-principal" class="barraTitulo">Turnador</h1></a>\
        </div>\
      </div>\
	...
	<nav class="navbar navbar-default" role="navigation">\
      ...
      <ul id="barra-navegacion" class="nav nav-justified" align=center>\
        <li id="turnos-atendidos"><a     id="turnos-atendidos-active"     href="../turnos atendidos/generales.html">Turnos atendidos</a></li>\
