...
function cambiaEstilosVerdes (){
	...
	document.getElementById("cturnos").innerHTML = "<img src=\"../Detalle/images/circulo_verde01.png\">";
	document.getElementById("cturnos2").innerHTML = "<img src=\"../Detalle/images/circulo_verde02.png\">";	
	
	document.getElementById("monoEmpleado").innerHTML = "<img src=\"../Detalle/images/p_gde_verde_200.png\">";	
	document.getElementById("semanaEmpleado").innerHTML = "<img src=\"../Detalle/images/semana_v2.png\">";
...
function cambiaEstilosRojos (){
	...
	document.getElementById("cturnos").innerHTML = "<img src=\"../Detalle/images/circulo_rojo02.png\">";
	document.getElementById("cturnos2").innerHTML = "<img src=\"../Detalle/images/circulo_rojo01.png\">";
	
	document.getElementById("monoEmpleado").innerHTML = "<img src=\"../Detalle/images/p_gde_rojo_180.png\">";
	document.getElementById("semanaEmpleado").innerHTML = "<img src=\"../Detalle/images/semana_r2.png\">";
